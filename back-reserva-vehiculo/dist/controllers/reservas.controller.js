...
exports.getEstadoActualVehiculos = exports.getHistoricoReservasGlobal = exports.getHistoricoReservasPorUsuario = exports.getReservasActivasPorUsuario = exports.reservarVehiculo = void 0;
const database_1 = require("../config/database");
const mail_service_server_1 = require("../services/mail.service server");
const crypto_1 = __importDefault(require("crypto"));
/* 🔹 RESERVAR VEHÍCULO */
const reservarVehiculo = async (req, res) => {
    ...
    try {
        ...
        const tokenAprobacion = crypto_1.default.randomUUID();
      ...
      `);
        ...
        const { activo: estadoVehiculo, marca, modelo, matricula } = vehiculo.recordset[0];
        // 0 = LIBRE
        // 1 = OCUPADO
        // 2 = PENDIENTE
        if (estadoVehiculo !== 1) {
      ...
      `);
        ...
        /* 5️⃣ CORREO */
        await (0, mail_service_server_1.enviarCorreoReservaPendiente)({
            usuario,
            vehiculo: {
                marca,
                modelo,
...
exports.reservarVehiculo = reservarVehiculo;
const getReservasActivasPorUsuario = async (req, res) => {
    try {
...
exports.getReservasActivasPorUsuario = getReservasActivasPorUsuario;
const getHistoricoReservasPorUsuario = async (req, res) => {
    try {
        const usuarioUpper = req.params.usuario.toUpperCase();
        const db = (0, database_1.getDB)();
...
exports.getHistoricoReservasPorUsuario = getHistoricoReservasPorUsuario;
const getHistoricoReservasGlobal = async (_req, res) => {
    try {
        const db = (0, database_1.getDB)();
...
exports.getHistoricoReservasGlobal = getHistoricoReservasGlobal;
const getEstadoActualVehiculos = async (_req, res) => {
    try {
        const db = (0, database_1.getDB)();
        const result = await db.request().query(`
      WITH UltimoLog AS (
...
exports.getEstadoActualVehiculos = getEstadoActualVehiculos;
